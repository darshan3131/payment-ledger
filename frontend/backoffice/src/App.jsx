...
const NAV = [
  ...
  },
  {
    ...
    icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 014-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 01-4 4H3"/></svg>
  },
  {
...
export default function App() {
  ...
  if (!user) {
    if (authPage === 'forgot') return <ForgotPassword onSwitchToLogin={() => setAuthPage('login')} accentColor="#22c55e" />
            ...
            <form onSubmit={handleCpSubmit} style={{display:'flex',flexDirection:'column',gap:12}}>
              ...
              <div style={{display:'flex',gap:8,justifyContent:'flex-end',marginTop:4}}>
                ...
                <button type="submit" disabled={cpSaving}
                  style={{padding:'8px 16px',background:'#22c55e',color:'white',border:'none',borderRadius:8,fontSize:13,fontWeight:500,opacity:cpSaving?.7:1,cursor:'pointer'}}>
